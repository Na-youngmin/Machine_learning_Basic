...
library(tidyverse)
library(factoextra)
pca1_g <- fviz_cos2(pca_res, choice = 'var', axes = 1, top = 5)
pca2_g <- fviz_cos2(pca_res, choice = 'var', axes = 2, top = 5)
cowplot::plot_grid(pca1_g, pca2_g, ncol = 2)
